...
$(document).ready(function () {
    $("#buscar-omnibus-form").submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../controlador/bus_search.php",
            data: $(this).serialize(),
            success: function (data) {
...
$(document).ready(function () {
    $("#buscar-ciudad-form").submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../controlador/city_search.php",
            data: $(this).serialize(),
            success: function (data) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    buscarRutaForm.addEventListener("submit", function (e) {
        ...
        xhr.open("POST", "../../controlador/route_search.php", true);
...
$(document).ready(function () {
    $("#buscar-parada-form").submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../controlador/search_stop.php",
            data: $(this).serialize(),
            success: function (data) {
